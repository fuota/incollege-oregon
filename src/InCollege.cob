...
Handle-Auth SECTION.
       EVALUATE User-Input
           ...
           WHEN OTHER
               MOVE "Invalid choice. Please try again." TO Message-Text
               PERFORM Write-And-Display
       END-EVALUATE.

Handle-Main-Selection SECTION.
       EVALUATE User-Input
           WHEN "1"
...
Learn-Skill-Menu SECTION.
       PERFORM UNTIL User-Input = "6"
           MOVE "1. AWS" TO Message-Text PERFORM Write-And-Display
           MOVE "2. Docker" TO Message-Text PERFORM Write-And-Display
           MOVE "3. COBOL" TO Message-Text PERFORM Write-And-Display
           MOVE "4. Azure" TO Message-Text PERFORM Write-And-Display
           MOVE "5. GCP" TO Message-Text PERFORM Write-And-Display
           MOVE "6. Return to main menu" TO Message-Text PERFORM Write-And-Display
           MOVE "Enter your choice (1-6): " TO Message-Text PERFORM Write-And-Display
           ...
           EVALUATE User-Input
               ...
               WHEN "5"
                   ...
                   PERFORM Write-And-Display
               WHEN "6"
                   MOVE "Returning to main menu..." TO Message-Text
                   PERFORM Write-And-Display
               WHEN OTHER
                   MOVE "Invalid skill choice. Please try again." TO Message-Text
                   PERFORM Write-And-Display
           END-EVALUATE
       END-PERFORM
       EXIT.
...
Create-Account SECTION.
       ...
       PERFORM UNTIL Username-Exists = 'Y'
           READ AccountsFile
               AT END
                   CLOSE AccountsFile
                   IF FUNCTION LENGTH(FUNCTION TRIM(Account-Username-Input)) > 0
                      AND FUNCTION LENGTH(FUNCTION TRIM(Account-Username-Input)) < 50
